...
BLOGS = [
    {
        "topic": "초고령화 시대의 역설: 실버 타운과 헬스케어 로보틱스 산업에서 찾는 10년 장기 투자 기회",
        "source": "source_evergreen_4_aging_society.txt",
        "output": "Evergreen_Blog_4_Aging.md"
    },
]
...
def generate_blog(client, blog_info):
    ...
    try:
        ...
        업로드된 분석 소스 문서({source_file})의 내용을 바탕으로 구글 애드센스 SEO에 최적화된, 깊이 있고 통찰력 넘치는 에버그린(Evergreen) 블로그 포스트를 작성하세요.
